...
class ScaldingJobRunner(hadoop.JobRunner):
    ...
    def __init__(self):
        ...
        self.scala_home = conf.get('scalding', 'scala-home', None)
        self.scalding_home = conf.get('scalding', 'scalding-home', None)
        self.provided_dir = conf.get('scalding', 'scalding-provided', None)
        self.libjars_dir = conf.get('scalding', 'scalding-libjars', None)
